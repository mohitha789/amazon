...
public class Addcart extends AbstractMethods {

	public Addcart(WebDriver driverhere) {
		super(driverhere);
	...
	@FindBy(xpath = "//*[@id=\"hmenu-content\"]/ul[23]/li[6]/a")
	WebElement audiobooknewReleases;
	By audiobooks_newReleases = By.xpath("//*[@id=\"hmenu-content\"]/ul[23]/li[6]/a");

	@FindBy(xpath = "//input[@id='add-to-wishlist-button-submit']")
	WebElement wishlistadd;

	@FindBy(xpath = "(//a[text()='Audible Membership'])[1]")
	...
	@FindBy(xpath = "//a[@id='itemName_ILFH3M7C3QM9Q']")
	...
	@FindBy(xpath = "(//input[@name='submit.add-to-registry.wishlist'])[2]")
	...
	@FindBy(xpath = "//a[text()='View Wish List']")
	WebElement viewlist;
